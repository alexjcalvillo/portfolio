    ...
    <div className="mb-24">
      <div className="flex flex-col items-center">
        <img
          ...
          alt="project still"
        />
        <div className="relative -mt-20 shadow-lg z-10 rounded-lg bg-gray-100 w-11/12 h-56 p-3 flex flex-col items-center">
          <span className="text-2xl text-gray-700 font-light antialiased tracking-wide">
            {ProjectTitle}
          </span>
          <span className="text-gray-700 font-thin tracking-wide text-xs mt-4">
            {Description}
          </span>
          <button className="w-5/6 py-2 border-2 border-gray-400 rounded-md m-auto transition-all duration-500 hover:bg-gray-400 hover:text-white">
            See Project
            <svg
